...
Here are the guidelines we'd like you to follow (picked up from webpack-contrib):
...
{
  "devDependencies": {
    "drupal-librarify-webpack-plugin": "ducks-project/drupal-librarify-webpack-plugin#{id}/head"
  }
}
```
